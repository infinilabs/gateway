...
import (
	...
	_ "infini.sh/gateway/pipeline/dump_hash"
	_ "infini.sh/gateway/pipeline/es_scroll"
	_ "infini.sh/gateway/pipeline/fast_bulk_indexing"
	_ "infini.sh/gateway/pipeline/fast_flow_runner"
	_ "infini.sh/gateway/pipeline/flow_replay"
	_ "infini.sh/gateway/pipeline/flow_runner"
	_ "infini.sh/gateway/pipeline/index_backup"
	_ "infini.sh/gateway/pipeline/index_diff"
	_ "infini.sh/gateway/pipeline/queue_consumer"
	_ "infini.sh/gateway/pipeline/replication_correlation"
