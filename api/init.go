...
//
//	//Stats APIs
//	//ui.HandleUIMethod(api.GET, "/_proxy/stats", apis.StatsAction)
//	//ui.HandleUIMethod(api.POST, "/_proxy/queue/resume", apis.QueueResumeAction)
//	//ui.HandleUIMethod(api.GET, "/_proxy/queue/stats", apis.QueueStatsAction)
